...
[![Action Run Using](https://img.shields.io/badge/dynamic/yaml?url=https%3A%2F%2Fraw.githubusercontent.com%2Fcssnr%2Fvirustotal-action%2Frefs%2Fheads%2Fmaster%2Faction.yml&query=%24.runs.using&logo=githubactions&logoColor=white&label=runs)](https://github.com/cssnr/actionlint-action/blob/master/action.yml)
[![Workflow Release](https://img.shields.io/github/actions/workflow/status/cssnr/virustotal-action/release.yaml?logo=norton&logoColor=white&label=release)](https://github.com/cssnr/virustotal-action/actions/workflows/release.yaml)
[![Workflow Test](https://img.shields.io/github/actions/workflow/status/cssnr/virustotal-action/test.yaml?logo=norton&logoColor=white&label=test)](https://github.com/cssnr/virustotal-action/actions/workflows/test.yaml)
[![Workflow Lint](https://img.shields.io/github/actions/workflow/status/cssnr/virustotal-action/lint.yaml?logo=norton&logoColor=white&label=lint)](https://github.com/cssnr/virustotal-action/actions/workflows/lint.yaml)
...
[![GitHub Last Commit](https://img.shields.io/github/last-commit/cssnr/virustotal-action?logo=github&label=updated)](https://github.com/cssnr/virustotal-action)
...
[![GitHub Repo Size](https://img.shields.io/github/repo-size/cssnr/virustotal-action?logo=buffer&label=repo%20size)](https://github.com/cssnr/virustotal-action?tab=readme-ov-file#readme)
[![GitHub Top Language](https://img.shields.io/github/languages/top/cssnr/virustotal-action?logo=devbox)](https://github.com/cssnr/virustotal-action?tab=readme-ov-file#readme)
[![GitHub Contributors](https://img.shields.io/github/contributors-anon/cssnr/virustotal-action?logo=southwestairlines)](https://github.com/cssnr/virustotal-action/graphs/contributors)
[![GitHub Issues](https://img.shields.io/github/issues/cssnr/virustotal-action?logo=codeforces&logoColor=white)](https://github.com/cssnr/virustotal-action/issues)
[![GitHub Discussions](https://img.shields.io/github/discussions/cssnr/virustotal-action?logo=livechat&logoColor=white)](https://github.com/cssnr/virustotal-action/discussions)
[![GitHub Forks](https://img.shields.io/github/forks/cssnr/virustotal-action?style=flat&logo=forgejo&logoColor=white)](https://github.com/cssnr/virustotal-action/forks)
[![GitHub Repo Stars](https://img.shields.io/github/stars/cssnr/virustotal-action?style=flat&logo=gleam&logoColor=white)](https://github.com/cssnr/virustotal-action/stargazers)
...
- [Request a Feature](https://github.com/cssnr/virustotal-action/issues/new?template=1-feature.yaml)
- [Chat with us on Discord](https://discord.gg/wXy6m2X8wY)

[![Features](https://img.shields.io/badge/features-brightgreen?style=for-the-badge&logo=rocket&logoColor=white)](https://github.com/cssnr/virustotal-action/issues/new?template=1-feature.yaml)
[![Issues](https://img.shields.io/badge/issues-red?style=for-the-badge&logo=southwestairlines&logoColor=white)](https://github.com/cssnr/virustotal-action/issues)
[![Discussions](https://img.shields.io/badge/discussions-blue?style=for-the-badge&logo=livechat&logoColor=white)](https://github.com/cssnr/virustotal-action/discussions)
...
- [smashedr/ai-issue-action](https://github.com/smashedr/ai-issue-action?tab=readme-ov-file#readme) - AI issue triage.
...
<a href="https://portainer-deploy.cssnr.com/">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=cssnr/virustotal-action&type=date&legend=bottom-right&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=cssnr/virustotal-action&type=date&legend=bottom-right" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=cssnr/virustotal-action&type=date&legend=bottom-right" />
 </picture>
</a>
